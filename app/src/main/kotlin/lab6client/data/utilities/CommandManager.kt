...
import lab6client.data.commands.gui.UpdateTable
...
data class CommandManager(
    ...
    private val gui: HomeFrame? = null,
    ...
    private val commandSet: HashMap<String, () -> Any> = hashMapOf(
        ...
        "demotivate" to {Demotivate(lang).execute(arguments)},
        "table" to {UpdateTable(lang, gui).execute(arguments)},
